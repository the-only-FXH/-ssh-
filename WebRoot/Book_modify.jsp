...
<table width='100%' cellspacing='1' cellpadding='3' class="tablewidth">
  ...
  <tr>
    <td width=30%>出版日期:</td>
    <td width=70%><input type="text" readonly  id="book.publishDate"  name="book.publishDate" onclick="setDay(this);" value='<%=book.getPublishDate() %>'/></td>
  </tr>
  ...
  <tr>
    <td width=30%>图书简介:</td>
    <td width=70%><textarea id="book.introduction" name="book.introduction" rows="6" cols="80"><%=book.getIntroduction() %></textarea></td>
  </tr>
